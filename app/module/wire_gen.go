...
import (
	...
	"git.yingzhongshare.com/mkt/kitty/pkg/kkafka/client"
...
func injectModule(reader contract.ConfigReader, logger log.Logger, dynConf config.DynamicConfigReader) (*Module, func(), error) {
	...
	userCache := repository.NewUserCache(universalClient)
	appService := handlers.NewAppService(reader, logger, userRepo, codeRepo, fileRepo, senderFacade, wechaterFacade, dispatcher, uniqueID, userCache)
